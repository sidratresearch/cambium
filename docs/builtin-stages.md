...
- CheckLinks
- EnsureIndexPages
  - Creates `index.html` files in all folders. This prevents someone from seeing the complete listing of files in a given folder (as they will instead be served the blank `index.html` page).
